    ...
    public static void main(String[] args) throws IOException {
        ...
        simulationThreads.execute(()->{
            ...
            for(int i=0;i<10000;i++) {
                mpg.onSimulateMessage(String.format("%d, EUR/USD, 1.1000,1.2000,01-06-2020 12:01:01:001\n%d, EUR/JPY, 119.60,119.90,01-06-2020 12:01:02:002\n%d, GBP/USD, 1.2500,1.2560,01-06-2020 12:01:02:002", id++, id++, id++));
                try {
